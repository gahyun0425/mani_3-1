...
{
  new (message_memory) my_vision_msgs::msg::HarvestOrdering(_init);
}

void HarvestOrdering_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_vision_msgs::msg::HarvestOrdering *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HarvestOrdering_message_member_array[4] = {
  {
    ...
    offsetof(my_vision_msgs::msg::HarvestOrdering, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_vision_msgs::msg::HarvestOrdering, crop_ids),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_vision_msgs::msg::HarvestOrdering, objects),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_vision_msgs::msg::HarvestOrdering, total_objects),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HarvestOrdering_message_members = {
  ...
  4,  // number of fields
  sizeof(my_vision_msgs::msg::HarvestOrdering),
...
{
  return &::my_vision_msgs::msg::rosidl_typesupport_introspection_cpp::HarvestOrdering_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_vision_msgs, msg, HarvestOrdering)() {
  return &::my_vision_msgs::msg::rosidl_typesupport_introspection_cpp::HarvestOrdering_message_type_support_handle;
}

...
bool my_vision_msgs__msg__crop_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_vision_msgs.msg._crop_pose.CropPose", full_classname_dest, 38) == 0);
  }
  my_vision_msgs__msg__CropPose * ros_message = _ros_message;
  {  // header
...
PyObject * my_vision_msgs__msg__crop_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_vision_msgs.msg._crop_pose");

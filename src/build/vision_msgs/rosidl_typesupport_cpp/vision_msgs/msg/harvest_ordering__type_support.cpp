...
static const _HarvestOrdering_type_support_symbol_names_t _HarvestOrdering_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, HarvestOrdering)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_msgs, msg, HarvestOrdering)),
  }
};
...
{
  return &::vision_msgs::msg::rosidl_typesupport_cpp::HarvestOrdering_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vision_msgs, msg, HarvestOrdering)() {
  return get_message_type_support_handle<vision_msgs::msg::HarvestOrdering>();
}

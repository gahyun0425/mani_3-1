...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(720, 634);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        MainWindowDesign->setWindowIcon(icon);
        MainWindowDesign->setStyleSheet(QString::fromUtf8("QMainWindow {\n"
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        Motor->setText(QCoreApplication::translate("MainWindowDesign", "Motor Node (Priority)", nullptr));
        Map->setText(QCoreApplication::translate("MainWindowDesign", "Map Node", nullptr));

...
static rosidl_typesupport_introspection_c__MessageMember vision_msgs__msg__CropPose__rosidl_typesupport_introspection_c__CropPose_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(vision_msgs__msg__CropPose, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__CropPose, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__CropPose, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
